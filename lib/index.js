...
*/
setReadOnly( ns, 'add', require( '@stdlib/number-float64-base-add' ) );
...
*/
setReadOnly( ns, 'add3', require( '@stdlib/number-float64-base-add3' ) );
...
*/
setReadOnly( ns, 'add4', require( '@stdlib/number-float64-base-add4' ) );
...
*/
setReadOnly( ns, 'add5', require( '@stdlib/number-float64-base-add5' ) );
...
*/
setReadOnly( ns, 'identity', require( '@stdlib/number-float64-base-identity' ) );
...
*/
setReadOnly( ns, 'ulpdiff', require( '@stdlib/number-float64-base-ulp-difference' ) );
